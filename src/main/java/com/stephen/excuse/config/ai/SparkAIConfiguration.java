package com.stephen.excuse.config.ai;

import com.stephen.excuse.config.ai.condition.SparkAICondition;
import com.stephen.excuse.config.ai.properties.SparkAIProperties;
